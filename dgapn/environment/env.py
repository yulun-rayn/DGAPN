...
from dgapn.dataset.get_dataset import download_dataset, unpack_dataset
from dgapn.dataset.preprocess import read_data

from dgapn.utils.graph_utils import mol_to_pyg_graph
...
class CReM_Env(object):
    def __init__(self,
        ...
        if not self.grow:
            self.scores, self.smiles = read_data(os.path.join(data_path, warm_start_dataset))
